                            ...
                            <div class="col-lg-4 mb-5 mb-lg-0">
                                <div class="bg-white p-5 rounded-lg shadow">
                                    ...
                                    <ul class="list-unstyled my-5 text-small text-left basic">
                                        <li class="mb-3">
                                            <i class="fa fa-check mr-2 text-primary"></i>Weight lifting games and prices
                                        </li>
                                        <li class="mb-3"> 
                            ...
                            <div class="col-lg-4 mb-5 mb-lg-0">
                                <div class="bg-white p-5 rounded-lg shadow">
                                    ...
                                    <ul class="list-unstyled my-5 text-small text-left font-weight-normal pro">
                                        ...
                                        <li class="mb-3">
                                            <i class="fa fa-check mr-2 text-primary"></i>Easy Refund
                                        </li>
                                        <li class="mb-3">
