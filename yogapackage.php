                            ...
                            <div class="col-lg-4 mb-5 mb-lg-0">
                                <div class="bg-white p-5 rounded-lg shadow">
                                    ...
                                    <ul class="list-unstyled my-5 text-small text-left basic">
                                        <li class="mb-3">
                                            <i class="fa fa-check mr-2 text-primary"></i>Foundation[starting with deep breathing and flow]
                                        </li>
                                        <li class="mb-3">
                                            <i class="fa fa-check mr-2 text-primary"></i>Alignment[simple yoga postures]
                                        </li>
                                        <li class="mb-3">
                                            <i class="fa fa-check mr-2 text-primary"></i>Strength & Power
                                        </li>
                                        <li class="mb-3 text-muted">
                                            <i class="fa fa-times mr-2"></i>
                                            <del>The Art of Flow</del>
                                        </li>
                                        <li class="mb-3 text-muted">
                                            <i class="fa fa-times mr-2"></i>
                                            <del>Practice Presence</del>
                                        </li>
                            ...
                            <div class="col-lg-4 mb-5 mb-lg-0">
                                <div class="bg-white p-5 rounded-lg shadow">
                                    ...
                                    <ul class="list-unstyled my-5 text-small text-left font-weight-normal pro">
                                        <li class="mb-3">
                                            <i class="fa fa-check mr-2 text-primary"></i>28 days Yoga Program[upa yoga,bhuta shuddhi,yogasanas,...]
                                        </li>
                                        <li class="mb-3">
                                            <i class="fa fa-check mr-2 text-primary"></i>Naukasana (boat pose)
                                        </li>
                                        <li class="mb-3">
                                            <i class="fa fa-check mr-2 text-primary"></i>Paschimottanasana (head to toe)
                                        </li>
                                        <li class="mb-3">
                                            <i class="fa fa-check mr-2 text-primary"></i>Angamardana
                                        </li>
                                        <li class="mb-3">
                                            <i class="fa fa-check mr-2 text-primary"></i>Hot Cold Water Shower after yoga
                                        </li>
                                        <li class="mb-3">
                                            <i class="fa fa-check mr-2 text-primary"></i>Pick up and Drop
                                        </li>
