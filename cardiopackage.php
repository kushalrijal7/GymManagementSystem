...
<body>
    ...
    <section class="header">
        ...
        <section class="gym" id="programs">
            ...
            <h1>CARDIOVASCULAR TRAINING PACKAGE</h1>
            <div class="row">
                <section>
                            ...
                            <div class="col-lg-4 mb-5 mb-lg-0">
                                <div class="bg-white p-5 rounded-lg shadow">
                                    ...
                                    <ul class="list-unstyled my-5 text-small text-left basic">
                                        <li class="mb-3">
                                            <i class="fa fa-check mr-2 text-primary"></i>Indoor runing workout
                                        </li>
                                        <li class="mb-3">
                                            <i class="fa fa-check mr-2 text-primary"></i>Diet foods in breakfast
                                        </li>
                                        <li class="mb-3">
                                            <i class="fa fa-check mr-2 text-primary"></i>Cycling hill workout
                                        </li>
                                        <li class="mb-3 text-muted">
                                            <i class="fa fa-times mr-2"></i>
                                            <del>Free 1 month membership</del>
                                        </li>
                                        <li class="mb-3 text-muted">
                                            <i class="fa fa-times mr-2"></i>
                                            <del>Free cycle for cycling</del>
                                        </li>
                                        <li class="mb-3 text-muted">
                                            <i class="fa fa-times mr-2"></i>
                                    ...
                                    <a href="basicpackage.php" onmouseover="this.style.color='white'" onmouseout="this.style.color='yellow'" class="btn btn-primary btn-block p-2 shadow rounded-pill basic" style="color: yellow;">Subscribe</a>
                                </div>
                            </div>
                            <!-- END -->
                            ...
                            <div class="col-lg-4 mb-5 mb-lg-0">
                                <div class="bg-white p-5 rounded-lg shadow">
                                    ...
                                    <ul class="list-unstyled my-5 text-small text-left font-weight-normal pro">
                                        <li class="mb-3">
                                            <i class="fa fa-check mr-2 text-primary"></i>Burpees and swimming free
                                        </li>
                                        <li class="mb-3">
                                        ...
                                        <li class="mb-3">
                                            <i class="fa fa-check mr-2 text-primary"></i>Free cycle for cycling exercise
                                        </li>
                                        <li class="mb-3">
                                    ...
                                    <a href="premiumpackage.php" onmouseover="this.style.color='white'" onmouseout="this.style.color='yellow'" class="btn btn-primary btn-block p-2 shadow rounded-pill pro" style="color: yellow;">Subscribe</a>
                                </div>
                            </div>
                            <!-- END -->
