...
if(isset($_POST['premiumregister'])){
    ...
    $data = "INSERT INTO `premium_register`(`firstname`, `lastname`, `age`, `package`, `trainer`,`training`, `date`) VALUES ('$first_name','$last_name','$age','$package','$trainer','$training','$date')";
    ...
    if ($result){
        echo 'premium package registered';
...
<body>
    ...
    <section class="header">
        ...
        <h2>---Premium Subscription Package---</h2>
        <div id="error"></div>
        <form action="premiumpackage.php" id="forms-box" method="POST">
            ...
            <br>
            <button type='submit' name="premiumregister" id="premiumregister" style="color: blue;">Subscribe</button>
