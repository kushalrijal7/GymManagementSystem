...
if(isset($_POST['advanceregister'])){
    ...
    $data = "INSERT INTO `advance_register`(`firstname`, `lastname`, `age`,`package`, `program`, `trainer`,`training`, `date`) VALUES ('$first_name','$last_name','$age','$package','$program','$trainer','$training','$date')";
...
<body>
    ...
    <section class="header">
        ...
        <div id="error"></div>
        <form action="advance.php" id="forms-box" method="POST">
            ...
            <br>
            <button type='submit' name="advanceregister" id="advanceregister" style="color: blue;">Advance Register</button>
