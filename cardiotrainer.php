...
<body>
    ...
    <section class="header">
        ...
        <h2 style="text-align:center; color:yellow;">--Cardiovascular Trainer--</h2>

        <div class="card">
            <img src="img/cardiovascular.jpg" alt="image" style="width:100%">
            <h2>Robert Thapa</h2>
            <p class="title">Professional Cardiovascular Instructor</p>
